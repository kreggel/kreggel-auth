...
public class UserService {
    ...
    public User createUser(String username, String password, String email ) throws ErrorCodeBasedException {
        ...
        try {
            ...
            throw new ErrorCodeBasedException(500, "User creation failed", e.getCause());
        }
    }
